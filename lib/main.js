(async function() {
  'use strict';
  var A_demo, A_prepare_arena, A_trash, FSE, GUY, PATH, alert, debug, demo_dbay, echo, get_cfg, help, info, inspect, log, plain, praise, reverse, rpr, urge, warn, whisper;
